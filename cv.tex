...
\tabentry
  ...
  \ind{1.5ex}{\textbf{Details:}}\\%
    \bulletlist
    {Created a campaign management dashboard that \jdb{allowed users to monitor impressions and generate metrics reports.}}
    {Developed software for displaying HTML5 inside \jdb{mobile apps in accordance with the MRAID specifications.}}
    {Created seamless canvas video players for mobile \jdb{browsers (including Firefox and Native Android).}}
    {Built canvas modules that rendered and played \jdb{animations with no lag on desktop or mobile devices.}}
  }
\tabentry
  {01/2012 – 11/2013}
  {LearnBop Inc.}
