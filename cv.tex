...
\tabentry
  ...
  {Kargo Global}
  {Sr. Web Developer}
  {Lead Angular developer at a global adtech company. Developed feature rich tools that facilitate exchange between advertisers and publishers. Big on open source contributions. I build software that meets business needs.\\%
  \ind{1.5ex}{\textbf{Details:}}\\%
    ...
    {Fostered cross team communication with a slack bot that\jdb{fetched relevant images, gifs, and lines of text}}
