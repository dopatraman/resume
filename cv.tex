...
\tabentry
  ...
  {Kargo Global}
  {Sr. Web Developer}
  {Lead Angular developer at a global adtech company. Developed feature rich tools that facilitate exchange between advertisers and publishers. Most of my work here has used Angular for front-end application management/infrastructure and canvas for interactivity. Meeting business needs with software was #1 priority, sometimes necessitated modifying 3rd party libraries.\\%
  \ind{1.5ex}{\textbf{Details:}}\\%
    \bulletlist
    {Modified core Angular modules to allow for inheritance\jdb{and mixins between controllers and directives}}
    {Fostered cross team communication by making a \jdb{slack bot that fetched information from the web}\jdb{according to commands sent in a slack channel}}
    {Created a workflow tool that allowed members \jdb{of the development team to rapidly and easily}\jdb{generate documentation for various software products}}
